...
public class YK_Time : MonoBehaviour
{
    ...
    [SerializeField] private YK_Clock Clock;            // 時止めを使うためのコンポーネント
    ...
    void Update()
    {
        ...
        // time変数をint型にし、制限時間から引いた数をint型のlimit変数に代入
