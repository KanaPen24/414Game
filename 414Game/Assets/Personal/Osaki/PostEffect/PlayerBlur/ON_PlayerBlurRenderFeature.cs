...
public class ON_PlayerBlurRenderFeature : ScriptableRendererFeature
{
    ...
    private ON_PlayerBlurRenderPass _postProcessPass;

    public override void Create()
    {
        _postProcessPass = new ON_PlayerBlurRenderPass(_applyToSceneView, _shader);
    }
